...
<html>
    <head>
        <title>Admin | Area Management</title>
    ...
    <body>
        ...
        <div style=" background-color: #f5f5f5;">
            <div class="container">
                ...
                <div class="row z-depth-1" style=" margin-top:5px; background-color: #cfd8dc;">                    
                    ...
                    <div class="col s12 m2 l2 right-align">
                        <a href="Admin_area_management.jsp"><h4 style="font-family:constantia;color:#42a5f5;font-size:15px;">Area Management</h4></a>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <h4 style="font-family:constantia;color:#4D4D4D;font-size:25px;">Area Management</h4>
            ...
            <div class="row">
                <form class="col m12 l12" method="POST">
                    <div class="row">                       
                        ...
                        <div class="col m4 l4 center-align" style="margin-top: 25px;">
